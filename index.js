...
// Celsius Conversion
// Formula F to C: (tempInFahrenheit - 32) * 5 / 9
...
// Formula C to F: (tempInCelsius * 9 / 5) + 32
...
console.log(`Total Temp in Celsius: ${tot_temperature_in_celsius.toFixed(2)}C`);
console.log(`Average Temp in Celsius: ${avg_temperature_in_celsius.toFixed(2)}C`);
console.log(`Total Temp in Fahrenheit: ${tot_temperature_in_fahrenheit.toFixed(2)}F`);
console.log(`Average Temp in Fahrenheit: ${avg_temperature_in_fahrenheit.toFixed(2)}F`);
